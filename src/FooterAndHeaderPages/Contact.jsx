...
const ContactPage = () => {
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Contact Details */}
      <div className="grid md:grid-cols-3 gap-6 p-10  text-white text-center">
        <div className="bg-teal-800 p-4">
          <h2 className="text-lg font-bold">ADDRESS</h2>
          <p className="mt-2">
            Wexford Group Consulting
            <br />
            Colorado, USA 80203
          </p>
          <p>
            ...
            <br />
            1109 7th Ave NW, Ardmore, OK
          </p>
        </div>
        <div className="bg-teal-800 flex items-center justify-center flex-col">
          <h2 className="text-lg font-bold">PHONE</h2>
          <p className="mt-2">Wexford 24/7 Service: 303-555-1212</p>
          <p>Northern Division Office: 580-555-9090</p>
        </div>
        <div className="bg-teal-800 flex flex-col items-center justify-center">
